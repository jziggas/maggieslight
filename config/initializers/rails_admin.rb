# RailsAdmin config file. Generated on August 05, 2013 00:05
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Community Works Caregiver Registry', 'Admin Dashboard']
  ...
  config.excluded_models = ['Connection']
  ...
  # config.model 'CareProviderProfile' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your care_provider_profile.rb model definition
  ...
  # config.model 'CareReceiverProfile' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your care_receiver_profile.rb model definition
